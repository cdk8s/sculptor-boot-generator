...
public class GeneratorForeignKeyOneToQueryMapperBO implements GeneratorStrategy {

	@Override
	public void generatorFile(VelocityContext context, Configuration config) {
		String template = "templates/velocity/backend/bo/mapper/ForeignKeyOneToQueryMapperBO.java.vm";
