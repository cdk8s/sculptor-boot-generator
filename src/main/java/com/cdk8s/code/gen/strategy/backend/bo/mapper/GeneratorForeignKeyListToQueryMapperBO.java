...
public class GeneratorForeignKeyListToQueryMapperBO implements GeneratorStrategy {

	@Override
	public void generatorFile(VelocityContext context, Configuration config) {
		String template = "templates/velocity/backend/bo/mapper/ForeignKeyListToQueryMapperBO.java.vm";
		...
		if (null != foreignKeyColumns) {
			...
			for (ColumnEntity entity : columnEntityList) {
				...
				String fileName = getFileName(config, tableEntity.getUpperClassName(), entity.getUpperAttrName(), "ListMapperBO");
