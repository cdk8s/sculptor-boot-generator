...
public class GeneratorRelationTableKeyToDeleteParam implements GeneratorStrategy {

	@Override
	public void generatorFile(VelocityContext context, Configuration config) {
		String template = "templates/velocity/backend/param/RelationTableKeyToDeleteParam.java.vm";
		...
		String fileName = getFileName(config, tableEntity.getUpperClassName(), filePrefix, "ToDeleteRequestParam");
