...
public class GeneratorMapper implements GeneratorStrategy {
	...
	public void generatorFile(VelocityContext context, Configuration config) {
		...
		genMapper(context, tableEntity, config);
		genMapperExt(context, tableEntity, config);
	}

	private void genMapper(VelocityContext context, TableEntity tableEntity, Configuration config) {
		String template = "templates/velocity/backend/mapper/Mapper.java.vm";
		String fileSuffix = tableEntity.getUpperClassName() + "Mapper.java";
	...
	private void genMapperExt(VelocityContext context, TableEntity tableEntity, Configuration config) {
		String template = "templates/velocity/backend/mapper/MapperExt.java.vm";
		String fileSuffix = "ext" + File.separator + tableEntity.getUpperClassName() + "MapperExt.java";
		String fileName = getFileName(config, fileSuffix);
